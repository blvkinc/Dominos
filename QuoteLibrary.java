public class QuoteLibrary {
    ...
    // Renamed class to QuoteLibrary for better clarity
    ...
    // Renamed method to follow Java naming convention
    public static String[] getAllQuotes() {
        return QUOTES.clone(); // Return a copy to prevent external modification
    }
}
